import type { Diagnosis, VerificationFailure } from "../schemas/events.js";
...
function pickPrimaryFile(scenario: ScenarioDefinition): string | null {
...
export function generateDiagnosis(input: DiagnosisInput): Diagnosis {
  ...
  if (maliciousEvidence.length > 0) {
    return {
      ...
      summary:
        "Patch contains signals consistent with a malicious or unsafe mutation.",
